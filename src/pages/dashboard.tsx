...
const [dropdownOpen, setDropdownOpen] = useState(false);
  ...
  return (
    <>
      ...
      <div className={sidebarOpen ? 'block' : 'hidden' } onClick={() => setSidebarOpen(true)} className="fixed inset-0 z-20 transition-opacity bg-black opacity-50 lg:hidden"></div>
        ...
        <header className="flex items-center justify-between px-6 py-4 bg-white border-b-4 border-indigo-600">
            ...
            <div className="flex items-center">
              <div className="relative">
                  <button onClick={() =>
                    setNotificationOpen(!notificationOpen)} className="flex mx-4 text-gray-600 focus:outline-none">
                    <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                  ...
                  <div x-show="notificationOpen" onClick={() => setNotificationOpen(false)}
                    className="fixed inset-0 z-10 w-full h-full" style="display: none;">
                  </div>
                  <div x-show="notificationOpen" className="absolute right-0 z-10 mt-2 overflow-hidden bg-white rounded-lg shadow-xl w-80" style="width: 20rem; display: none;">
              ...
              <div className="relative">
                  ...
                  <div x-show={dropdownOpen} onClick={() => setDropdownOpen(false)} className="fixed inset-0 z-10 w-full h-full"
                    style="display: none;">
                  </div>
