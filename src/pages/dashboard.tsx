...
const [dropdownOpen, setDropdownOpen] = useState(false);
  ...
  return (
    ...
    <div x-data="{ sidebarOpen: false }" className="flex h-screen bg-gray-200">
        <div className={sidebarOpen ?'block' : 'hidden' } onClick={() => setSidebarOpen(true)}
            ...
            <header className="flex items-center justify-between px-6 py-4 bg-white border-b-4 border-indigo-600">
                ...
                <div className="flex items-center">
                    <div x-data="{ notificationOpen: false }" className="relative">
                        <button onClick={() => setNotificationOpen(!false)} className="flex mx-4 text-gray-600 focus:outline-none">
                            <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
